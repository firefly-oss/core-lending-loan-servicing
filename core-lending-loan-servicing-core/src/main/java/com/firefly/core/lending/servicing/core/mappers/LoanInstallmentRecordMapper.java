...
public interface LoanInstallmentRecordMapper {
    LoanInstallmentRecordDTO toDTO(LoanInstallmentRecord entity);
    LoanInstallmentRecord toEntity(LoanInstallmentRecordDTO dto);
}
