...
public interface LoanDisbursementInternalTransactionMapper {
    LoanDisbursementInternalTransactionDTO toDTO(LoanDisbursementInternalTransaction entity);
    LoanDisbursementInternalTransaction toEntity(LoanDisbursementInternalTransactionDTO dto);
}
