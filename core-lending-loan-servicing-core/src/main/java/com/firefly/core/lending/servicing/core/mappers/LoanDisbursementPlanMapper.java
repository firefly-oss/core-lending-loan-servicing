...
public interface LoanDisbursementPlanMapper {
    LoanDisbursementPlanDTO toDTO(LoanDisbursementPlan entity);
    LoanDisbursementPlan toEntity(LoanDisbursementPlanDTO dto);
}
