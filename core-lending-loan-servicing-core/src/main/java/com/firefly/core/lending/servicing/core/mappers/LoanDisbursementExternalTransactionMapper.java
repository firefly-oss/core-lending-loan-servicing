...
public interface LoanDisbursementExternalTransactionMapper {
    LoanDisbursementExternalTransactionDTO toDTO(LoanDisbursementExternalTransaction entity);
    LoanDisbursementExternalTransaction toEntity(LoanDisbursementExternalTransactionDTO dto);
}
