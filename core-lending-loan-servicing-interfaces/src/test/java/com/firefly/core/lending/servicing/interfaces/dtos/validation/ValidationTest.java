...
public class ValidationTest {
    ...
    void testLoanServicingCaseDTO_ValidData_NoViolations() {
        LoanServicingCaseDTO dto = LoanServicingCaseDTO.builder()
                ...
                .loanTerm(60)
                .interestCalculationMethod(InterestCalculationMethodEnum.ACTUARIAL)
                .amortizationMethod(AmortizationMethodEnum.EQUAL_INSTALLMENT)
                .paymentFrequency(PaymentFrequencyEnum.MONTHLY)
                .compoundingFrequency(CompoundingFrequencyEnum.MONTHLY)
                .dayCountConvention(DayCountConventionEnum.ACTUAL_365)
