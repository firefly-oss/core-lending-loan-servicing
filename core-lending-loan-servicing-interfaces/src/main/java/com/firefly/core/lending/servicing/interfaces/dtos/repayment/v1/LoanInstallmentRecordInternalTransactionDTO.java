...
@NoArgsConstructor
@AllArgsConstructor
public class LoanInstallmentRecordInternalTransactionDTO {
    ...
    private UUID sourceAccountId; // Customer's internal account (payer)

    @NotNull(message = "Destination account ID is required")
    private UUID destinationAccountId; // Loan's internal account (receiver)
